...
EN: An interactive Discord assistant for IU (Lee Ji-eun) fans, featuring a paginated discography, mood-based song recommendations, and fun mini-games. (Only available for Turkish users)
